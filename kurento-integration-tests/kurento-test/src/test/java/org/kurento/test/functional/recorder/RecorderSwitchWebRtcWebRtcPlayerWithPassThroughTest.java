...
/**
 * Test of a Recorder switching sources from PassThrough connected to WebRtc Endpoint and Player
 * Endpoint
 * </p>
 * Media Pipeline(s):
 * <ul>
 * <li>WebRtcEndpoint -> PassThrough -> RecorderEndpoint; WebRtcEndpoint -> PassThrough ->
 * RecorderEndpoint</li>
 * <li>WebRtcEndpoint -> PassThrough -> RecorderEndpoint; PlayerEndpoint -> PassThrough ->
 * RecorderEndpoint</li>
 ...
 * Test logic:
 * <ol>
 * <li>(KMS) Two media pipelines. First WebRtcEndpoint -> PassThrough -> RecorderEndpoint
 * (recording) and then WebRtcEndpoint -> PassThrough -> RecorderEndpoint (recording). And the
 * second PlayerEndpoint -> WebRtcEndpoint (play of the recording).</li>
 * <li>(KMS) Two media pipelines. First WebRtcEndpoint -> PassThrough -> RecorderEndpoint
 * (recording) and then PlayerEndpoint -> PassThrough -> RecorderEndpoint (recording). And the
 * second PlayerEndpoint -> WebRtcEndpoint (play of the recording).</li>
 ...
 * @since 6.5.1
 */
public class RecorderSwitchWebRtcWebRtcPlayerWithPassThroughTest extends BaseRecorder {
  ...
  @Test
  public void testRecorderSwitchWebRtcWebRtcWithPassThroughWebm() throws Exception {
    doTest(WEBM, EXPECTED_VIDEO_CODEC_WEBM, EXPECTED_AUDIO_CODEC_WEBM, EXTENSION_WEBM);
  }

  @Ignore
  @Test
  public void testRecorderSwitchWebRtcWebRtcWithPassThroughMp4() throws Exception {
    doTest(MP4, EXPECTED_VIDEO_CODEC_MP4, EXPECTED_AUDIO_CODEC_MP4, EXTENSION_MP4);
  }

  @Test
  public void testRecorderSwitchWebRtcPlayerWithPassThroughWebm() throws Exception {
  ...
  @Test
  public void testRecorderSwitchWebRtcPlayerWithPassThroughMp4() throws Exception {
    doTestWithPlayer(WEBM, EXPECTED_VIDEO_CODEC_WEBM, EXPECTED_AUDIO_CODEC_WEBM, EXTENSION_WEBM,
