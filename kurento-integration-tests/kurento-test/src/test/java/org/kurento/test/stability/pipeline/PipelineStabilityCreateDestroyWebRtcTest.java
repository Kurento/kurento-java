 ...
 * <ol>
 * <li>M will be a constant value</li>
...
@Ignore
public class PipelineStabilityCreateDestroyWebRtcTest extends BasePipeline {
  ...
  @Ignore
  public void testCreateDestroyWebRtcOnePipelineDestroyPipeline() throws Exception {
    doTest(1, false, false);
    doTest(1, false, true);
  }

  @Ignore
  public void testCreateDestroyWebRtcOnePipelineDestroyEachWebRtc() throws Exception {
    doTest(1, true, false);
    doTest(1, true, true);
  }

  @Ignore
  public void testCreateDestroyWebRtcMPipelineDestroyPipeline() throws Exception {
    doTest(M, false, false);
    doTest(M, false, true);
  }

  @Ignore
  public void testCreateDestroyWebRtcMPipelineDestroyEachWebRtc() throws Exception {
    doTest(M, true, false);
    doTest(M, true, true);
  }
