 ...
 * <li>Connect by pairs, The first generates offer, the second processes the offer and the first
 * processes answer</li>
...
@Ignore
public class PipelineStabilityCreateDestroyWebRtcGenerateProcessOfferAndAnswerTest
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateProcessOfferAndAnswerOnePipelineDestroyPipeline()
      throws Exception {
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateProcessOfferAndAnswerOnePipelineDestroyEachWebRtc()
      throws Exception {
    // Stabilize the memory on the KMS
    doTest(1, true, false);
    // Use the assert for checking memory
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateProcessOfferAndAnswerMPipelineDestroyPipeline()
      throws Exception {
    // Stabilize the memory on the KMS
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateProcessOfferAndAnswerMPipelineDestroyEachWebRtc()
      throws Exception {
    // Stabilize the memory on the KMS
    doTest(M, true, false);
    // Use the assert for checking memory
