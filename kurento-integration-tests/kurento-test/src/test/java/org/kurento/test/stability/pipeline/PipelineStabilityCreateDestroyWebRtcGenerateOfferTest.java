...
/**
 * Stability test for Pipelines and WebRtcEndpoints. <br/>
 * Test logic: <br/>
 * <ul>
 ...
 * <li>Generate offer for each webRtcEndpoint</li>
...
@Ignore
public class PipelineStabilityCreateDestroyWebRtcGenerateOfferTest extends BasePipeline {
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateOfferOnePipelineDestroyPipeline() throws Exception {
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateOfferOnePipelineDestroyEachWebRtc() throws Exception {
    // Stabilize the memory on the KMS
    doTest(1, true, false);
    // Use the assert for checking memory
    doTest(1, true, true);
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateOfferMPipelineDestroyPipeline() throws Exception {
    // Stabilize the memory on the KMS
  ...
  @Ignore
  public void testCreateDestroyWebRtcGenerateOfferMPipelineDestroyEachWebRtc() throws Exception {
    // Stabilize the memory on the KMS
    doTest(M, true, false);
    // Use the assert for checking memory
    doTest(M, true, true);
